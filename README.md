...
適用戶別：**A2、B2**，以及格局相同、上下翻轉的 **A6、B6**（畫面左上角的「戶別」可以切換）。
...
| 3D 鳥瞰 | 左鍵拖曳旋轉、右鍵平移、滾輪縮放；左側工具列的「切牆」可以把牆切到 150 公分高，方便看室內 |
...
- 工作陽台 188.5 × 172.5
- 陽台門開在瓦斯爐正對面（客餐廳右牆）
- 樓高約 3 米（模型室內高度設 300 公分，可以在「空間材質」分頁調整）
- 冷氣平台格柵不高過窗戶（目前設 110 公分，與陽台女兒牆同高）
