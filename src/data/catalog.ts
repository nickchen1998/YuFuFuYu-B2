...
const seeds: Seed[] = [
  ...
  // 主臥：加大雙人床 6 尺床頭靠左牆，兩側 30 公分床頭櫃；上牆左段是 45 公分深的薄型衣櫃（對開窄門，前方留 52 公分）
  ...
  // 椅子背後（靠客廳的隔間牆）：矮櫃放文件、線材、印表機，上方書櫃做到頂。
  // 從衣櫃往下留 65（衣櫃最左邊那扇門要開）、到次臥門前 5 公分為止；矮櫃避開按摩椅前方，書櫃在按摩椅那段懸空
  { id: 'scab', type: 'cabinet', name: '書房矮櫃（文件・印表機）', x: 323, y: 340, rot: 90, w: 250, d: 40, h: 90, color: '#e4dccf' },
  { id: 'sshelf', type: 'bookshelf', name: '書櫃（到頂）', x: 318, y: 295, rot: 90, w: 340, d: 30, h: 210, elev: 90, color: '#e4dccf' },
