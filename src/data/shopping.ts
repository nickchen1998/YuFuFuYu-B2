...
export const shopping: Record<string, ShopInfo> = {
  ...
  fridge: {
    summary: '冰箱上方沒有吊櫃，高度不受限；寬度預留 70，選寬 60～66 的機種，左右和背面留散熱空間。',
    specs: [
      '機身寬 ≤ 66（左右各留 1～2 散熱）',
      '機深 ≤ 65（背面留 5）',
      '上方留 5～10 散熱',
      '鉸鏈側靠牆的話留 5 以上，門才開得到 90°、抽屜拉得出來',
    ],
    picks: [
      {
      ...
      {
        name: 'Panasonic NR-B371TV（366L 雙門）',
        detail: '65 × 65.6 × 178.5，一級能效；上方依壓縮機位置留 5～10',
        price: '約 NT$18,911（2026/09 PChome）',
        url: 'https://24h.pchome.com.tw/prod/DPAC1T-A900FLZQU',
        source: 'PChome',
      },
      {
        name: 'LG GN-L307SV（253L 雙門）',
        detail: '55.5 × 62 × 166.5，體積小；兩人用容量偏小',
        price: '價格請以通路為準',
        url: 'https://lg.com/tw/refrigerators/lg-GN-L307SV',
        source: 'LG 官網',
      },
    ],
    search: ['日立 RV41C', 'NR-B371TV', 'GN-L307SV'],
    notes: [
